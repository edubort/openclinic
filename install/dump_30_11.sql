...
MySQL - 5.5.5-10.0.17-MariaDB : Database - openclinic
*********************************************************************
*/
...
insert  into `history_tbl`(`id_patient`,`birth_growth`,`growth_sexuality`,`feed`,`habits`,`peristaltic_conditions`,`psychological`,`children_complaint`,`venereal_disease`,`accident_surgical_operation`,`medicinal_intolerance`,`mental_illness`,`parents_status_health`,`brothers_status_health`,`spouse_childs_status_health`,`family_illness`) values (1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'asdfasd','asdfasdf','asdfasdf','10-10-2015+-+visita+bla+bla+bla'),(3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `patient_tbl`(`id_patient`,`nif`,`first_name`,`surname1`,`surname2`,`address`,`phone_contact`,`sex`,`race`,`birth_date`,`birth_place`,`decease_date`,`nts`,`nss`,`family_situation`,`labour_situation`,`education`,`insurance_company`,`id_member`) values (1,'aaa','Andre','Medina',NULL,'aaa','aa','V','aaa','2010-03-02','teste','0000-00-00','aa','aa','aaa','aaa','aaa','aaa',3),(2,'12','Joao','Siqueira',NULL,NULL,NULL,'V',NULL,'0000-00-00',NULL,'0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'1234','Maria+Rosa++B.','Bortolotti',NULL,'aaa','aaa','H',NULL,'0000-00-00',NULL,'0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'j100','Nome','Sobrenome',NULL,'asdfasdf','sdasdfas','V',NULL,'0000-00-00',NULL,'0000-00-00',NULL,NULL,NULL,'o+pai+trabalho+na+empresa...%0D%0Aa+mae+na+empresa+x',NULL,NULL,NULL);
...
insert  into `problem_tbl`(`id_problem`,`last_update_date`,`id_patient`,`id_member`,`order_number`,`opening_date`,`closing_date`,`meeting_place`,`wording`,`subjective`,`objective`,`appreciation`,`action_plan`,`prescription`) values (1,'2015-11-08',2,NULL,1,'2015-11-08',NULL,NULL,'a','a','a','a','a','a'),(2,'2015-11-08',2,NULL,2,'2015-11-08',NULL,NULL,'b','b','b','b','b','b'),(3,'2015-11-08',3,3,1,'2015-11-08',NULL,NULL,'asdfasdfasdfasfdasdf',NULL,NULL,NULL,NULL,NULL);
...
insert  into `session_tbl`(`login`,`last_updated_date`,`token`) values ('carmelo','2015-11-08 09:01:10',8555),('admin','2015-11-30 16:04:12',7348);
