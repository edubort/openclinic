 ...
 */
  ...
  if ($_SESSION['auth']['is_administrative'])
  {
    ...
    $relatedLinks .= ' | ';
    $relatedLinks .= HTML::link(_("Excluir beneficiário"), '../medical/patient_del_confirm.php',
      array('id_patient' => $idPatient)
    );
  }
  echo HTML::para($relatedLinks);

  $relatedLinks = HTML::link(_("Visualizar Relações"), '../medical/relative_list.php',
    array('id_patient' => $idPatient)
  );
  $relatedLinks .= ' | ';
  $relatedLinks .= HTML::link(_("Histórico"), '../medical/history_list.php',
    array('id_patient' => $idPatient)
  );
  $relatedLinks .= ' | ';
  $relatedLinks .= HTML::link(_("Registros clínicos"), '../medical/problem_list.php',
    array('id_patient' => $idPatient)
  );
  $relatedLinks .= ' | ';
